<?php /* Smarty version 2.6.28, created on 2016-02-09 04:02:35
...
" border="0">
        ...
        <td align="right" >
            <p>
                <div class="buttons">
				<a href="<?php echo $this->_tpl_vars['g_base_url']; ?>
/out.php" class="regular"><img src="<?php echo $this->_tpl_vars['g_base_url']; ?>
/images/home.png" alt="Home"/><?php echo $this->_tpl_vars['g_lang_home']; ?>
</a>
				<a href="<?php echo $this->_tpl_vars['g_base_url']; ?>
/profile.php" class="regular"><img src="<?php echo $this->_tpl_vars['g_base_url']; ?>
/images/user.png" alt="User"/>Profile</a>
				<a href="<?php echo $this->_tpl_vars['g_base_url']; ?>
/help.html" onClick="return popup(this, 'Help')" class="regular"><img src="<?php echo $this->_tpl_vars['g_base_url']; ?>
/images/help.png" alt="Help"/><?php echo $this->_tpl_vars['g_lang_help']; ?>
</a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
	<tr>
		...
		<td bgcolor="#e77817" align="left" width="500">
			<span class="statusbar">Logged as <?php echo $this->_tpl_vars['userName']; ?>
</span>
		</td>
		<?php endif; ?>
...
/help.html" onClick="return popup(this, 'Help')" style="text-decoration:none"><?php echo $this->_tpl_vars['g_lang_help']; ?>
		...
		<td bgcolor="#e77817" align="left">
			<span class="statusbar"><img src="<?php echo $this->_tpl_vars['g_base_url']; ?>
/images/folder.png" alt="Home"/> Path:  <?php echo $this->_tpl_vars['breadCrumb']; ?>
</span>
		</td>
		<td bgcolor="#e77817" align="right" valign="middle">
			<b><font size="-2" face="Arial" color="White">System Message: <?php echo $this->_tpl_vars['lastmessage']; ?>
</font></b>
		</td>
	</tr>
</table>
